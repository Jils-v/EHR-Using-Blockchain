...
import { setAccess, setuserdata } from "../store/slices/PatientStore";
import { setconnect, setuser } from "../store/slices/SimpleStore";
import { useDispatch } from "react-redux";
import { fetchHospitaldata } from "../store/slices/HospitalStore";
        ...
        if (usertype == "patient") {
          ...
          dispatch(
            setuserdata({
              ...
              WriteAccess: detail.writeAccess,
          ...
          const detail = await Contract.getHospitalDetail(accounts[0]);
          dispatch(
            fetchHospitaldata({
              publicAddress: detail.publicAddress,
              name: detail.name,
